    ...
    <div className="space-y-8 max-w-7xl mx-auto px-2 md:px-4 py-4 md:py-8 h-full overflow-y-auto">
      ...
      <div className="relative rounded-[3rem] overflow-hidden border border-slate-800/80 shadow-2xl bg-slate-950 min-h-[260px] md:min-h-[300px] flex flex-col justify-between p-6 md:p-10">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={notebookBg} 
            alt="Notebook Ambient Atmosphere" 
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            {onOpenUniversityTracker && (
              <button
                ...
                className="px-5 py-3.5 bg-slate-900/80 hover:bg-slate-800 text-white rounded-2xl font-black text-xs uppercase tracking-wider flex items-center gap-2 transition-all border border-slate-700/80 shadow-lg active:scale-95 cursor-pointer backdrop-blur-md group"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredNotebooks.map((nb, nbIdx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="notebook-page-black notebook-binder-holes pl-12 pr-6 py-6 border border-slate-800/90 hover:border-indigo-500/60 rounded-[2.5rem] shadow-xl hover:shadow-2xl hover:shadow-indigo-500/10 flex flex-col justify-between space-y-6 transition-all group relative overflow-hidden backdrop-blur-md"
            >
              {/* Subtle accent bar on hover */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-indigo-500 via-blue-500 to-sky-400 opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              <div className="space-y-3">
                ...
                <h3 className="text-xl font-black text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors leading-snug">
                  {nb.title}
                </h3>
