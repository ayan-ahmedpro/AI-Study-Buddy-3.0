  ...
  return (
    <div className="min-h-screen h-full overflow-y-auto bg-slate-950 text-white p-4 sm:p-8 flex flex-col items-center">
      <div className="w-full max-w-6xl space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-900/80 border border-slate-800 p-5 rounded-3xl backdrop-blur-xl shadow-2xl">
        ...
        {!isPro && (
          <div className="bg-gradient-to-r from-amber-500/20 via-blue-500/10 to-indigo-500/20 border border-amber-500/30 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-widest bg-amber-500 text-slate-950 px-2 py-0.5 rounded-md flex items-center gap-1">
                    <Zap className="w-2.5 h-2.5 fill-current" /> PRO FEATURE
                  </span>
                  <h4 className="font-black text-white text-base">University & Degree Tracker</h4>
                </div>
                <p className="text-xs text-slate-300 mt-1">
                  Searching top global and regional universities with degree matching and scholarship criteria is a Pro feature.
                </p>
              </div>
            </div>
            <button
              ...
              className="px-6 py-3.5 bg-gradient-to-r from-amber-400 to-amber-500 text-slate-950 rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg shrink-0 cursor-pointer flex items-center gap-2"
            >
