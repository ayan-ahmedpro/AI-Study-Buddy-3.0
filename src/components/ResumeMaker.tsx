                 ...
                 <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                    ...
                    <div className="space-y-6">
                      {data.experience.map((exp, idx) => (
                        <div key={exp.id} className="bg-white p-8 rounded-[2rem] border-2 border-slate-100 shadow-sm space-y-6 relative group">
                          <button 
                 ...
                 <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                    ...
                    <div className="space-y-6">
                      {data.education.map((edu, idx) => (
                        <div key={edu.id} className="bg-white p-8 rounded-[2rem] border-2 border-slate-100 space-y-6 relative">
                          <button 
