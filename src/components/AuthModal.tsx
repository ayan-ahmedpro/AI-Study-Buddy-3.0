  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (err?.code === 'auth/popup-closed-by-user') {
        ...
        setError('Google Sign-In network request failed. If you are using an embedded preview or popup blocker, please sign in with Email & Password below or open the app in a new browser tab.');
      } else if (err?.code === 'auth/popup-blocked') {
        setError('Pop-up window was blocked by your browser. Please allow pop-ups or use Email & Password sign in.');
      } else if (err?.code === 'auth/operation-not-allowed') {
        setError('Google Sign-In is not enabled in Firebase Auth settings. Please use Email & Password sign-in.');
      } else {
              ...
              {mode === 'signup' && (
                <label className="flex items-center gap-3 cursor-pointer pt-1">
                  ...
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">
                    I agree to the <span className="text-blue-600 dark:text-blue-400 font-bold underline">Terms of Service</span> and <span className="text-blue-600 dark:text-blue-400 font-bold underline">Privacy Policy</span>.
                  </span>
                </label>
              )}
