...
export default function ScholarshipTracker({
  ...
  return (
    <div className="bg-slate-900 text-white rounded-3xl border border-slate-800 shadow-2xl overflow-hidden max-w-6xl w-full mx-auto my-4 flex flex-col h-full overflow-y-auto max-h-[92vh]">
      {/* Top Bar Header with Prominent Back Button & How It Works */}
      <div className="bg-slate-950 px-6 py-5 border-b border-slate-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shrink-0">
